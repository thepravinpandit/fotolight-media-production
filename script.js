...
const DEFAULT_DATA = window.FOTOLIGHT_DEFAULT_DATA || {
  ...
  portfolio: [
    ...
    { src: "img/portfolio/optimized/1K2A0934.webp", alt: "Portfolio image 2" },
    { src: "img/portfolio/optimized/img-15.webp", alt: "Portfolio image 3" },
    { src: "img/portfolio/optimized/1K2A9712.webp", alt: "Portfolio image 4" },
    { src: "img/portfolio/optimized/img-13.webp", alt: "Portfolio image 5" },
    { src: "img/portfolio/optimized/img-18.webp", alt: "Portfolio image 6" },
    { src: "img/portfolio/optimized/img-20.webp", alt: "Portfolio image 7" },
    { src: "img/portfolio/optimized/img-36.webp", alt: "Portfolio image 8" },
    { src: "img/portfolio/optimized/img-25.webp", alt: "Portfolio image 9" },
  ],
  photos: [
    { src: "img/portfolio/optimized/1K2A9793.webp", alt: "Photo tile 1" },
    { src: "img/portfolio/optimized/1K2A9705.webp", alt: "Photo tile 2" },
    { src: "img/portfolio/optimized/1K2A5257.webp", alt: "Photo tile 3" },
    { src: "img/portfolio/optimized/img-33.webp", alt: "Photo tile 4" },
    { src: "img/portfolio/optimized/img-35.webp", alt: "Photo tile 5" },
    { src: "img/portfolio/optimized/img-37.webp", alt: "Photo tile 6" },
  ],
  videos: [
    {
...
const applyPhotos = (photos) => {
  ...
  const dotsContainer = photoSlider?.querySelector(".photo-slider__dots");
...
const initPhotoSlider = () => {
  ...
  const track = photoSlider.querySelector(".photo-grid");
  const slides = Array.from(track.children);
  if (!slides.length) return;
  const prevBtn = photoSlider.querySelector(".photo-slider__btn--prev");
  const nextBtn = photoSlider.querySelector(".photo-slider__btn--next");
  const dotsContainer = photoSlider.querySelector(".photo-slider__dots");
  ...
  photoSlider.addEventListener("focusin", stopAuto);
  photoSlider.addEventListener("focusout", startAuto);
